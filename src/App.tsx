...
function App() {
  ...
  const calculateFare = useCallback((distanceKm: number, waitingMinutes: number, sorianaBonus: boolean = false) => {
    ...
    if (selectedTripType.fixedPrice || (selectedTripType.id === 'cristoRey' && selectedSubTrip)) {
      ...
      return baseCost + waitingCost + sorianaExtraFee;
    }
    ...
    return fare + (waitingMinutes * RATES.waitingRate) + sorianaExtraFee;
                ...
                <div className="flex items-center">
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-sm text-gray-300">
                      {serviciosExtrasActive ? 'Servicios Extras activado' : 'Servicios adicionales'}
                    </div>
                  </div>
                </div>
                <div className="flex items-center">
                  {serviciosExtrasActive && (
